        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-4xl mx-auto mb-16">
            ...
            <div className="space-y-12">
              ...
              {/* 29 de Abril de 2026 - DIREITA (NOVO) */}
              <div className="relative flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-8" />
                <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-emerald-600 rounded-full border-4 border-white hidden md:block" />
                <div className="md:w-1/2 md:pl-8 mb-4 md:mb-0">
                  <Card className="bg-white border-emerald-100 shadow-lg hover:shadow-xl transition-shadow">
                    <CardContent className="p-6">
                      <div className="flex items-center gap-2 text-emerald-600 mb-2">
                        <Calendar className="w-5 h-5" />
                        <span className="font-semibold">29 de Abril de 2026</span>
                      </div>
                      <h3 className="text-xl font-bold text-slate-900 mb-2">
                        Internet nas Dunas do Jalapão
                      </h3>
                      <p className="text-slate-600">
                        Governador Wanderlei Barbosa autoriza obras nas Dunas do Jalapão e leva internet
                        à comunidade quilombola, com investimento superior a R$ 1,4 milhão, fortalecendo
                        a infraestrutura turística e beneficiando comunidades, trabalhadores do turismo e visitantes.
                      </p>
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="relative flex flex-col md:flex-row items-center">
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4
               bg-orange-600 rounded-full border-4 border-white hidden md:block" />
              <div className="md:w-1/2 md:pl-8" />
            </div>
