...
const perguntasIndicador = [
  {
    ...
    resposta: 'SIM',
    evidencias: [
      'Programa Tocantins Conectado — abordagem multitecnológica com 3 eixos complementares (Wi-Fi, Satélite LEO, LTE/4G)',
      ...
      'Articulação com Anatel e Ministério das Comunicações para expansão do 5G — 54 novos municípios cobertos'
    ]
  },
  {
    id: '1.12c',
    ...
    resposta: 'SIM',
    evidencias: [
      'Tocantins Conectado Eixo 01 — Wi-Fi comunitário gratuito em 612 comunidades tradicionais via tótens e fibra óptica',
      'Tocantins Conectado Eixo 02 — Satélite LEO para comunidades indígenas e áreas rurais remotas sem infraestrutura terrestre',
      'Tocantins Conectado Eixo 03 — SIM Cards LTE (4G) individuais para cidadãos vulneráveis, com validação socioeconômica, territorial e tecnológica',
...
const documentosComprobatorios = [
  ...
  },
  {
    ...
    itens: [
      'Edital de contratação de Satélite LEO — justificativa de universalização para áreas onde o mercado não chega (referência institucional Tocantins Conectado Eixo 02)',
                ...
                <Card key={index} className="border-2 border-teal-200 overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-teal-50 to-white border-b border-teal-100">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2 bg-green-100 text-green-700 px-4 py-2 rounded-full font-bold flex-shrink-0 ml-4">
